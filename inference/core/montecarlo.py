...
def sim_old(
    ...
    # not sure if this acutally matters or not...
    # , dtype=np.intc
...
def sim(
    ...
    # rand_nos_nMbs = rand_nos.size * 8 * 0.000001
    # trial_indicies_nMbs = trial_indicies.size * 8 * 0.000001
    # configs_nMbs = configs.size * 8 * 0.000001
    # energy_nMbs = energy.size * 8 * 0.000001
    # print(rand_nos_nMbs, trial_indicies_nMbs, configs_nMbs, energy_nMbs)
    # nMBs = rand_nos_nMbs + trial_indicies_nMbs + configs_nMbs + energy_nMbs
    # print('Memory used:', nMBs, 'Mbs')
    return configs, energy
...
def simulate_old(
        interaction_matrix, initial_config, mc_cycles, cycle_dumpfreq=10):
    """
